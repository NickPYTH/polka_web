...
class All extends Seeder
{
    public function run()
    {
        $data = [
            ...
            'Price'=>2000,
            'pictureUrl'=>'http://polka.tplinkdns.com:9000/libra//book1.png',
        ];
        ...
        $data = [
            ...
            'Price'=>1500,
            'pictureUrl'=>'http://polka.tplinkdns.com:9000/libra//book2.png',
        ];
        $this->db->table('Books')->insert($data);
        $data = [
            'Name'=>'Java book 2',
            ...
            'Price'=>2500,
            'pictureUrl'=>'http://polka.tplinkdns.com:9000/libra//book3.png',
        ];
        $this->db->table('Books')->insert($data);
        $data = [
            'Name'=>'Java book 3',
            ...
            'Price'=>1500,
            'pictureUrl'=>'http://polka.tplinkdns.com:9000/libra//book4.png',
        ];
        $this->db->table('Books')->insert($data);
        ...
        $data = [
            ...
            'pictureUrl'=>'http://polka.tplinkdns.com:9000/libra//stupid_face.png',
        ];
