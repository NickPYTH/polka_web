...
return [
    // Регистрация пользователя (by kda)
    'register_user_link'                           => 'Создать учетную запись',
    'register_user_submit_btn'                        => 'Зарегистрироваться',
    'register_user_heading'                           => 'Регистрация в системе',
	// Errors
